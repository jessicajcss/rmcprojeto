...
### https://github.com/willianflores/getPurpleairApiHistory
### https://community.purpleair.com/t/r-script-to-retrieve-historical-data/3046
### https://github.com/willianflores/getPurpleairApiHistory/blob/main/getPurpleairApiHistory.R
##############################
#------------------------------------------------------------------------------------------#
